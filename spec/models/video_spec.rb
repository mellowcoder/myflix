...
describe Video do
  ...
  describe "search_by_title" do
    it "returns an empty array if there are is no match" do
      video = Fabricate(:video, title: 'The Family Guy', description: 'A comedy about a family and their dog.')
    ...
    it "returns an array of a multiple items ordered by created_at if there is a match on multiple records" do
      video = Fabricate(:video, title: 'The Family Guy', description: 'A comedy about a family and their dog.', created_at: 1.day.ago)
      video2 = Fabricate(:video, title: 'The Family Guy', description: 'A comedy about a family and their dog.')
